...
export const Dropzone: React.FC<DropzoneProps> = ({ onFileSelect, accept = "video/*", disabled = false }) => {
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center space-y-4 text-center p-6 relative z-10">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs font-mono text-slate-400">MP4, MKV, MOV (QUALQUER TAMANHO)</p>
        </div>
      </div>
    </div>
  );
